...
const SocialMediaLinks = ({inFooter, inMobileNav, inNav}) => {
    ...
    return (
        <StyledSocialMediaLinks id={inFooter ? "footerSocialIcons" : inMobileNav ? "mobileNavSocialIcons" : inNav ? "navSocialIcons" : ""}>
            {socialMediaList}
