...
import { closeCta } from '../reducers/ctaReducer';
...
const CallToAction = () => {
  ...
  const closeFormHandler = (e) => e.target.classList.contains("ctaScreen") ? dispatch(closeCta()) : null;
  ...
  return (
    <StyledCta className="ctaScreen" onClick={closeFormHandler}>
      <form className="ctaForm" onSubmit={submitCtaHandler}>
        ...
        <div className="ctaCloseBtn" onClick={() => dispatch(closeCta())}>
        ...
        <NavLink to="./About/Policies" className="ctaViewPolicies" onClick={() => dispatch(closeCta())}>View Policies</NavLink>
