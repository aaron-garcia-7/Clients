...
const TestimonialCard2 = ({ quote, name, title, img, dark }) => {
  return (
    <StyledTestimonialCard2
    ...
    >
      ...
      <div
        className="stripe"
        style={dark ? { background: "var(--tan)" } : { background: "var(--brown)" }}
      ></div>
...
const StyledTestimonialCard2 = styled("div")`
  width: 100%;
  min-width: 16rem;
  height: 100%;
  position: relative;
