...
import { container, fade, arrowRise, semiFade } from "../../anim/animations";
import styled from "styled-components";

import policiesImg from "../../images/photos/policiesImg.png";
...
const SecPolicies = () => {
  ...
  return (
    <StyledGuitarStyles ref={ref}>
      ...
      />
      {inView && (
        <img src={policiesImg} alt="Guitar head" className="portrait2" />
      )}
      ...
      >
        ...
        <motion.div variants={fade} className="navLinkBtn">
          <NavLink to="./Policies" className="mainNavLink">
            Learn more
          </NavLink>
        </motion.div>
      </motion.div>
