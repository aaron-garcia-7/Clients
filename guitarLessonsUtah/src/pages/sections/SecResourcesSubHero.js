...
const SecResourcesSubHero = ({ calendar, materials, links }) => {
  return (
    <StyledSecResourcesSubHero>
      <img
        src={
          calendar
            ? brownPickFill
      ...
      <img
        className={materials ? "backgroundImg" : "backgroundImg"}
        src={calendar ? woodBg2 : materials ? woodBg3 : links ? woodBg4 : null}
        alt=""
      />
      <h2 className="shadowText">
        {calendar ? "calendar" : materials ? "materials" : links ? "links" : ""}
      </h2>
    </StyledSecResourcesSubHero>
  );
};

const StyledSecResourcesSubHero = styled("section")`
  display: flex;
...
export default SecResourcesSubHero;
