...
const ContactPage = () => {
  ...
  return (
    <StyledContactPage>
      ...
      <img src={tanPickFill} className="contactPagePick1" />
      <img src={blackPickLine} className="contactPagePick2" />
      <motion.div
        className="textArea"
        variants={container}
        initial="initial"
      ...
      >
        ...
        >
          ...
          <div className="contactMethod">
            <p className="mainText">markveldevere[at]comcast.net</p>
            {/* <p className="mainText">markveldevere test sample</p> */}
          </div>
        </motion.a>
        <motion.a
          ...
          className="altLink"
        >
          <img src={location} className="contactIcon" />
          <div className="contactMethod">
...
const StyledContactPage = styled("section")`
  ...
  .contactPagePick1 {
    ...
    opacity: 0;
    animation: pickAppear 1s 2.4s ease forwards;
  }
  .contactPagePick2 {
    position: absolute;
    width: calc(2rem + 4vw);
    ...
    transform: translate(0, 100%);
    opacity: 0;
    animation: pickAppear 1.4s 2.6s ease forwards;
  }
