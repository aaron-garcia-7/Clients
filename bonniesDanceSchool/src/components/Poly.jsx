...
function Poly({inLocation, inFooter}) {
  ...
  return (
    <ScPoly id={inLocation ? "polyLocation" : inFooter ? "polyFooter" : null}>
        ...
        <circle cx="24" cy="16" r="7.5" stroke="var(--pink)" className="svg-elem-1"></circle>
        <circle cx="8" cy="16" r="7.5" stroke="var(--pink)" className="svg-elem-2"></circle>
        <circle cx="16" cy="8" r="7.5" stroke="var(--pink)" className="svg-elem-3"></circle>
        <circle cx="16" cy="24" r="7.5" stroke="var(--pink)" className="svg-elem-4"></circle>
        <circle cx="16" cy="24" r="3.5" stroke="var(--pink2)" className="svg-elem-5"></circle>
        <circle cx="8" cy="16" r="3.5" stroke="var(--pink2)" className="svg-elem-6"></circle>
        <circle cx="24" cy="16" r="3.5" stroke="var(--pink2)" className="svg-elem-7"></circle>
        <circle cx="16" cy="8" r="3.5" stroke="var(--pink2)" className="svg-elem-8"></circle>
        </svg>
    </ScPoly>
  )
}
