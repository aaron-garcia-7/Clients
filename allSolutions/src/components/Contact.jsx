        ...
        <StyledContact className="backScreen" onClick={closeContactHandler}>
            <div className="formBody">
                ...
                <motion.ul className="altContact" variants={fadeLateForm} initial="initial" animate="animate">
                    ...
                    <li>
                        <a href="tel:8017553040"><span>phone:</span> 801-755-3040</a>
                    </li>
                    {/* <li>
                        <a href=""><span>alt phone:</span> 801-234-5784</a>
                    </li> */}
                </motion.ul>
                <motion.form action="" onSubmit={formHandler} variants={containerForm} initial="initial" animate="animate">
                    <motion.div className="formBlock" variants={fadeGroupForm}>
                        ...
                        <label className="blockLabel" htmlFor="name">name</label>
                    </motion.div>
                    <motion.div className="formBlock" variants={fadeGroupForm}>
                        <input className="input" type="text" name="phone" placeholder=" " required/>
                        <label className="blockLabel" htmlFor="phone">phone</label>
                    </motion.div>
                    ...
                    <motion.div className="formBlock" variants={fadeGroupForm}>
                        ...
                        <label className="blockLabel" htmlFor="message">message <span className={isRequired ? "jump" : ""}>{isRequired ? "explain service" : "optional"}</span></label>
                    </motion.div>
                    <motion.button variants={fadeGroupForm}>submit</motion.button>
                </motion.form>
                <div className="divider" />
                <header>
                    <h2>Let’s get <br className="hideBr"/> started</h2>
                    <motion.p variants={fadeLateForm} initial="initial" animate="animate">We look forward to working with you and restoring comfort to your home.</motion.p>
                </header>
            </div>
        </StyledContact>
    )
    ...
    .formBody{
        ...
        form {
            ...
            .formBlock {
                ...
                // Once Validated! This can also maintain label animation a required form is filled (use :valid)
                ...
                // This is the green check type styling!
            }
            div.formBlock {
                min-height: 2rem;
