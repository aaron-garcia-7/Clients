...
function Nav({ navOpen, setNavOpen, pageWidth }) {
    ...
    const handleNavHide = useCallback(
      ...
      const navStyle = {
        // transform: fromTop && scrollDown ? 'translate(0, -100%)' : !fromTop ? 'translate(0, -100%)' : 'translate(0, 0)',
        // transform: fromTop && scrollDown ? 'translate(0, -100%)' : !fromTop ? 'translate(0, -100%)' : pageWidth <= 768 ? 'translate(0, -100%)' : 'translate(0, 0)',
        transform: !scrollDown && fromTop ? 'translate(0, 0)' : 'translate(0, -100%)',
        // transform: !scrollDown && fromTop ? 'translate(0, 0)' : tabIndex ? 'translate(0, 0)' : 'translate(0, -100%)',
        // transform: !scrollDown && fromTop || tabIndex ? 'translate(0, 0)' : !tabIndex ? 'translate(0, -100%)' : 'translate(0, -100%)',
        transition: fromTop && scrollDown ? "0.6s ease, width 0s" : '0.4s ease, width 0s',
      }

  return (
    <ScNav style={navStyle}>
        <NavLink to="/" onClick={() => setNavOpen(false)} tabIndex={20} onFocus={() => setTabIndex(true)} onFocusOut={() => setTabIndex(false)}>
        ...
        <ul className='navLinks'>
            ...
            <li>
                <NavLink end to="/Team" tabIndex={23}>Team</NavLink>
            </li>
            <li>
                <a href="https://calendly.com/iconic-creative" target="_blank" rel="noreferrer" tabIndex={24} onFocusOut={() => setTabIndex(false)}>Let's Talk</a>
            </li>
        </ul>
