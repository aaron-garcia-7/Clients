...
function ServiceCard({id, order, title, img, price, text1, text2, text3, text4, text5, text6, before, after, inView, inView2, inView3}) {
    ...
    const cardStyle = {
        ...
        transform: inView ? 'skew(0deg)' : 'skew(-4deg)',
