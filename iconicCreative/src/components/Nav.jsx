...
function Nav({ navOpen, setNavOpen }) {
  ...
  return (
    <ScNav>
        <NavLink to="/" style={logoStyle} onClick={() => setNavOpen(false)}>
            <img src={logo} alt="iconic" className='navLogo'/>
        </NavLink>
        <ul className='navLinks' style={navStyle}>
            <li>
            ...
            <li>
                <a href="https://calendly.com/iconic-creative" target="_blank" rel="noreferrer">Let's Talk</a>
            </li>
        </ul>
