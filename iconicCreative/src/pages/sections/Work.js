  ...
  return (
    <ScWork>
      ...
      <button className="workBtn" style={parallaxStyle}>
        ...
        <NavLink to="/OurWork">See Our Work</NavLink>
...
const ScWork = styled("section")`
  ...
  @media (max-width: 480px) {
    ...
    .workText {
      top: calc(18rem + 24vw);
      transition: transform 0.6s cubic-bezier(0.28, 0.67, 0.6, 0.99);
    }
    .workBtn {
      top: calc(23rem + 48vw);
      transition: transform 0.2s cubic-bezier(0.28, 0.67, 0.6, 0.99);
    }
  }
`;
