    ...
    <div>
      ...
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          ...
          <Route
            path="/PrivacyPolicy"
            element={<Policy navOpen={navOpen} setNavOpen={setNavOpen} />}
          />
          <Route
            path="/Blog"
            element={<Blog navOpen={navOpen} setNavOpen={setNavOpen} />}
          />
          <Route
            path="/Contact"
            element={<Contact navOpen={navOpen} setNavOpen={setNavOpen} />}
          />
        </Routes>
      </AnimatePresence>
      <Footer />
